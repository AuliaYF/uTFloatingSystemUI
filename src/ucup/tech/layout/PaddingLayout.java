...
public class PaddingLayout extends LinearLayout{
	private Context mContext;
	public PaddingLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;

		int[] paddings = getPadding();
		PaddingLayout.this.setPadding(paddings[0], paddings[1], paddings[2], paddings[3]);
